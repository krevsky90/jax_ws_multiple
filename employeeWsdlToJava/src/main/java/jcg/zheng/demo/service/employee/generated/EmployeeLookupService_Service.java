 ...
 * 
 */
@WebServiceClient(name = "employeeLookupService", targetNamespace = "http://bestpay.payroll/employee", wsdlLocation = "file:/C:/workspace_Idea/jax_ws_multiple/employeeWsdlToJava/src/main/resources/wsdl/employeeService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/workspace_Idea/jax_ws_multiple/employeeWsdlToJava/src/main/resources/wsdl/employeeService.wsdl");
